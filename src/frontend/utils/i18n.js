...
const translations = reactive({
  en: {
    ...
    durableObjectsRequests: 'Durable Objects Billable Requests (est.)',
    rawRequests: 'raw',
    durableObjectsDuration: 'Durable Objects Duration (GB-s)',
  ...
  zh: {
    ...
    durableObjectsRequests: 'Durable Objects 计费请求数（估算）',
    rawRequests: '原始',
    durableObjectsDuration: 'Durable Objects 时长 (GB-s)',
    todayUsage: '当日消耗',
    yesterdayUsage: '昨天消耗',
    secondsAgo: '秒前',
    minutesAgo: '分钟前',
